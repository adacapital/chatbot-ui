...
AS $$
DECLARE
  project_url TEXT := 'https://iwrrdjdbtbikkdhkwdkt.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml3cnJkamRidGJpa2tkaGt3ZGt0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDM2NTUyOCwiZXhwIjoyMDQ5OTQxNTI4fQ.b33crqiXJbYgWWb_PFbbSc_w0ZnpbENAyurJRK6Gfoo'; -- full access needed for http request to storage
